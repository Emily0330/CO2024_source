...
void VSingleCycleCPU___024root___eval_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = (((~ (IData)(vlSelf->clk)) 
                                      ...
                                      | ((~ (IData)(vlSelf->start)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__start)));
    vlSelf->__VactTriggered.at(2U) = ((vlSelf->SingleCycleCPU__DOT__EXMEM_out_aluResult 
                                       != vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_aluResult) 
                                      | ((IData)(vlSelf->SingleCycleCPU__DOT__EXMEM_out_memRead) 
                                         != (IData)(vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_memRead)));

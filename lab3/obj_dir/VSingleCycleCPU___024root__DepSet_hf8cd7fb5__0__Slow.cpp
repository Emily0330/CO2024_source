...
VL_ATTR_COLD void VSingleCycleCPU___024root___eval_initial(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_aluResult 
        = vlSelf->SingleCycleCPU__DOT__EXMEM_out_aluResult;
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_memRead 
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] SingleCycleCPU.EXMEM_out_aluResult or [changed] SingleCycleCPU.EXMEM_out_memRead)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__nba(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] SingleCycleCPU.EXMEM_out_aluResult or [changed] SingleCycleCPU.EXMEM_out_memRead)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___ctor_var_reset(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->SingleCycleCPU__DOT__w23 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__w22 = VL_RAND_RESET_I(4);
    vlSelf->SingleCycleCPU__DOT__w7 = VL_RAND_RESET_I(2);
    vlSelf->SingleCycleCPU__DOT__w4 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__w5 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__w6 = VL_RAND_RESET_I(1);
    ...
    vlSelf->SingleCycleCPU__DOT__IFID_out_pc = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IFID_out_inst = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_pc = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_rs1 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_rs2 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_imm = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_funct3 = VL_RAND_RESET_I(3);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_ALUOp = VL_RAND_RESET_I(2);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_regWrite = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_memRead = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_memWrite = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_branch = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_ALUSrc = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_funct7 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_aluResult = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_pc = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_rs2 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_memRead = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_memWrite = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_regWrite = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_branch = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_zero = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__MEMWB_out_memData = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__MEMWB_out_aluResult = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__MEMWB_out_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__MEMWB_out_regWrite = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__IDEX_out_rd = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__EXMEM_out_rd = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__MEMWB_out_rd = VL_RAND_RESET_I(5);
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_aluResult = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__EXMEM_out_memRead = VL_RAND_RESET_I(1);

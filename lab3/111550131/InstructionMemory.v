module InstructionMemory (
    ...
    reg [7:0] insts [127:0]; // 128 instructions, each 8 bits
    
    assign inst = (readAddr >= 128) ? 32'b0 : {insts[readAddr], insts[readAddr + 1], insts[readAddr + 2], insts[readAddr + 3]}; // 32 bits per instruction                                            

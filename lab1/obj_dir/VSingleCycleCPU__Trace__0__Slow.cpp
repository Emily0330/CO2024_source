...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"w3", false,-1, 31,0);
    tracep->declBus(c+53,"w11", false,-1, 31,0);
    tracep->declBus(c+54,"w12", false,-1, 31,0);
    tracep->declBus(c+4,"w13", false,-1, 31,0);
    tracep->declBus(c+5,"w14", false,-1, 31,0);
    tracep->declBus(c+6,"w15", false,-1, 31,0);
    tracep->declBus(c+92,"w18", false,-1, 31,0);
    tracep->declBus(c+55,"w19", false,-1, 31,0);
    tracep->declBus(c+93,"w20", false,-1, 31,0);
    tracep->declBus(c+94,"w21", false,-1, 31,0);
    tracep->declBus(c+56,"w23", false,-1, 31,0);
    tracep->declBus(c+44,"w22", false,-1, 3,0);
    tracep->declBus(c+45,"w7", false,-1, 1,0);
    tracep->declBit(c+46,"w4", false,-1);
    tracep->declBit(c+47,"w5", false,-1);
    tracep->declBit(c+48,"w6", false,-1);
    tracep->declBit(c+49,"w8", false,-1);
    tracep->declBit(c+50,"w9", false,-1);
    tracep->declBit(c+51,"w10", false,-1);
    tracep->declBit(c+57,"w16", false,-1);
    ...
    tracep->declBus(c+44,"ALUCtl", false,-1, 3,0);
    tracep->declBus(c+95,"combined", false,-1, 5,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+49,"memWrite", false,-1);
    tracep->declBit(c+47,"memRead", false,-1);
    tracep->declBus(c+55,"address", false,-1, 31,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__w3),32);
    bufp->fullIData(oldp+4,(vlSelf->SingleCycleCPU__DOT__w13),32);
    bufp->fullIData(oldp+5,((vlSelf->SingleCycleCPU__DOT__w13 
                             << 1U)),32);
    bufp->fullIData(oldp+6,((vlSelf->SingleCycleCPU__DOT__w1 
                             + (vlSelf->SingleCycleCPU__DOT__w13 
                                << 1U))),32);
    bufp->fullBit(oldp+7,(((0x80U > vlSelf->SingleCycleCPU__DOT__w1) 
    ...
    bufp->fullCData(oldp+10,(((0x80U <= vlSelf->SingleCycleCPU__DOT__w1)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_ha7111f4a__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+11,(((0x80U <= vlSelf->SingleCycleCPU__DOT__w1)
    ...
    bufp->fullCData(oldp+44,(vlSelf->SingleCycleCPU__DOT__w22),4);
    bufp->fullCData(oldp+45,(vlSelf->SingleCycleCPU__DOT__w7),2);
    bufp->fullBit(oldp+46,(vlSelf->SingleCycleCPU__DOT__w4));
    bufp->fullBit(oldp+47,(vlSelf->SingleCycleCPU__DOT__w5));
    bufp->fullBit(oldp+48,(vlSelf->SingleCycleCPU__DOT__w6));
    bufp->fullBit(oldp+49,(vlSelf->SingleCycleCPU__DOT__w8));
    bufp->fullBit(oldp+50,(vlSelf->SingleCycleCPU__DOT__w9));
    bufp->fullBit(oldp+51,(vlSelf->SingleCycleCPU__DOT__w10));
    bufp->fullCData(oldp+52,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    bufp->fullIData(oldp+53,(vlSelf->SingleCycleCPU__DOT__w11),32);
    bufp->fullIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__w12),32);
    bufp->fullIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__w19),32);
    bufp->fullIData(oldp+56,(vlSelf->SingleCycleCPU__DOT__w23),32);
    bufp->fullBit(oldp+57,((0U == vlSelf->SingleCycleCPU__DOT__w19)));
    ...
    bufp->fullIData(oldp+92,((((0U == vlSelf->SingleCycleCPU__DOT__w19) 
                               & (IData)(vlSelf->SingleCycleCPU__DOT__w4))
                               ? (vlSelf->SingleCycleCPU__DOT__w1 
                                  + (vlSelf->SingleCycleCPU__DOT__w13 
                                     << 1U)) : ((IData)(4U) 
                                                + vlSelf->SingleCycleCPU__DOT__w1))),32);
    bufp->fullIData(oldp+93,(vlSelf->SingleCycleCPU__DOT__w20),32);
    bufp->fullIData(oldp+94,(vlSelf->SingleCycleCPU__DOT__w21),32);
    bufp->fullCData(oldp+95,((((IData)(vlSelf->SingleCycleCPU__DOT__w7) 
                               << 4U) | ((0x1ffffff8U 
                                          & (((0x80U 
                                               > vlSelf->SingleCycleCPU__DOT__w1) 
                                              << 3U) 
                                         ...
                                         | ((0x80U 
                                            ...
                                            (7U & ((IData)(vlSelf->__VdfgTmp_h809999bb__0) 
                                                   >> 4U)))))),6);
    bufp->fullBit(oldp+96,(((0U == vlSelf->SingleCycleCPU__DOT__w19) 
                            & (IData)(vlSelf->SingleCycleCPU__DOT__w4))));

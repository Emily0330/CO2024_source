...
void VSingleCycleCPU___024root___eval_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = (((~ (IData)(vlSelf->clk)) 
                                      ...
                                      | ((~ (IData)(vlSelf->start)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__start)));
    vlSelf->__VactTriggered.at(2U) = ((vlSelf->SingleCycleCPU__DOT__w19 
                                       != vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__w19) 
                                      | ((IData)(vlSelf->SingleCycleCPU__DOT__w5) 
                                         != (IData)(vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__w5)));

...
void VSingleCycleCPU___024root__trace_chg_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgIData(oldp+0,(vlSelf->SingleCycleCPU__DOT__w1),32);
        bufp->chgIData(oldp+1,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__w1)),32);
        bufp->chgIData(oldp+2,(vlSelf->SingleCycleCPU__DOT__w4),32);
        bufp->chgIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__w15),32);
        bufp->chgBit(oldp+4,(((0x80U > vlSelf->SingleCycleCPU__DOT__w1) 
                              & ((IData)(vlSelf->__VdfgTmp_h18b1efc1__0) 
                                 >> 6U))));
        bufp->chgCData(oldp+5,(((0x80U <= vlSelf->SingleCycleCPU__DOT__w1)
        ...
        bufp->chgCData(oldp+7,(((0x80U <= vlSelf->SingleCycleCPU__DOT__w1)
                                 ? 0U : (0x1fU & (vlSelf->__VdfgTmp_ha7111f4a__0 
                                                  >> 0xfU)))),5);
        bufp->chgCData(oldp+8,(((0x80U <= vlSelf->SingleCycleCPU__DOT__w1)
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgCData(oldp+41,(vlSelf->SingleCycleCPU__DOT__w16),4);
        bufp->chgCData(oldp+42,(vlSelf->SingleCycleCPU__DOT__w7),3);
        bufp->chgCData(oldp+43,(vlSelf->SingleCycleCPU__DOT__w6),2);
        bufp->chgBit(oldp+44,(vlSelf->SingleCycleCPU__DOT__w5));
        bufp->chgBit(oldp+45,(vlSelf->SingleCycleCPU__DOT__w8));
        bufp->chgBit(oldp+46,(vlSelf->SingleCycleCPU__DOT__w9));
        bufp->chgBit(oldp+47,(vlSelf->SingleCycleCPU__DOT__w10));
        bufp->chgBit(oldp+48,(vlSelf->SingleCycleCPU__DOT__w11));
        bufp->chgBit(oldp+49,(vlSelf->SingleCycleCPU__DOT__w12));
        bufp->chgCData(oldp+50,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgIData(oldp+51,(vlSelf->SingleCycleCPU__DOT__w3),32);
        bufp->chgIData(oldp+52,(vlSelf->SingleCycleCPU__DOT__w13),32);
        bufp->chgIData(oldp+53,(vlSelf->SingleCycleCPU__DOT__w14),32);
        bufp->chgIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__w17),32);
        bufp->chgIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__w18),32);
        bufp->chgIData(oldp+56,(vlSelf->SingleCycleCPU__DOT__w19),32);
        bufp->chgBit(oldp+57,((vlSelf->SingleCycleCPU__DOT__w13 
                               == vlSelf->SingleCycleCPU__DOT__w14)));
        bufp->chgBit(oldp+58,(VL_LTS_III(32, vlSelf->SingleCycleCPU__DOT__w13, vlSelf->SingleCycleCPU__DOT__w14)));
        bufp->chgCData(oldp+59,(vlSelf->SingleCycleCPU__DOT__m_ALU__DOT__combined),6);
    }
    ...
    bufp->chgIData(oldp+94,(vlSelf->SingleCycleCPU__DOT__w20),32);
    bufp->chgIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__w21),32);
    bufp->chgCData(oldp+96,((((IData)(vlSelf->SingleCycleCPU__DOT__w7) 
                              << 4U) | ((0x1ffffff8U 
                                         & (((0x80U 

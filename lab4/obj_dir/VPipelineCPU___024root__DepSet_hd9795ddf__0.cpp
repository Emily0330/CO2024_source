...
void VPipelineCPU___024root___eval_triggers__act(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = (((~ (IData)(vlSelf->clk)) 
                                      ...
                                      | ((~ (IData)(vlSelf->start)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__start)));
    vlSelf->__VactTriggered.at(2U) = ((vlSelf->PipelineCPU__DOT__EXMEM_aluResult 
                                       != vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXMEM_aluResult) 
                                      | ((IData)(vlSelf->PipelineCPU__DOT__EXMEM_memRead) 
                                         != (IData)(vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXMEM_memRead)));
